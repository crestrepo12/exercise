...
var desk = new RoomObject('desk', 'rectangle and has one drawer', ['sadoku', 'reading glasses', 'batteries' ], ['batteries'], 'open');

var nightTable = new RoomObject('night table', 'short and has two drawers', ['flashlight', 'notepad', 'pens'], ['flashlight'], 'open');

var closet = new RoomObject('closet', 'no doors and small', ['ironboard', 'keys', 'safe box'], ['keys'], 'walk in');

var trashCan = new RoomObject('trash can', 'small silver waste bin', ['newspaper', 'dirty tissue', 'stale chips'],[], 'dive in')


// Create an array of Room objects

var objects = [desk, nightTable, closet, trashCan];


// Create a new Game

var game = new Game ('hotel room')
...
var player = new Player('hotel room')
